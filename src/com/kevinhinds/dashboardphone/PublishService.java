...
/**
 * publish phone notifications to kevinhinds.net server
 * 
 * @author khinds
 */
public class PublishService {
	...
	/**
	 * push phone notification over to the dashboard reciever on kevinhinds.net
	 * 
	 * @param pack
	 * @param ticker
	 * @param title
	...
	public JSONObject pushNotification(String pack, String ticker, String title, String text) {
		...
		HttpPost httppostreq = new HttpPost("http://dashboard.kevinhinds.net/");
		StringEntity se;
		String responseText = null;
		EntityUtils entityUtils = null;
